...
## Results:
<img border="0" align="Left" src="https://github.com/nseddon/UFOs/blob/main/static/images/Initial%20Page%20Load.PNG"> On initial load of the webpage, the user will see a <br> welcome message and invitation to explore the data provided. <br>  The full table of data is displayed on initial load, awaiting user input to be filtered.
