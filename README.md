...
<div class="container" align="left">
  <div style="background-image">
    ...
    <text align="right">On initial load of the webpage, the user will see a <br> welcome message and invitation to explore the data provided.  The full table of data is displayed on initial load, awaiting user input to be filtered.</text>
  </div>
</div>
